...
struct NSEventKeyCodeToString {
  public static func convert(from: UInt16) -> String {
    return convert(from: Int(from))
  }
  
  public static func convert(from: Int) -> String {
    switch (from) {
